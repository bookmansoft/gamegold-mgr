export default {
  ...
  'menu.redpacket': '活动管理',
  'menu.redpacket.redpacketlist': '红包活动列表',
  'menu.redpacket.redpacketadd': '添加红包活动',
  'menu.redpacket.redpacketchange': '更改红包活动',
  'menu.redpacket.redpacketaddsuccess': '添加红包活动成功',
  ...
  'menu.operator': '企业客户',
  'menu.operator.operatorlist': '客户列表',
  'menu.operator.operatopassword': '修改密码',
  'menu.operator.operatorpasswordsuccess': '修改密码成功',
  'menu.operator.changephone': '修改手机号码',
  'menu.operator.changephonesuccess': '修改手机号码成功',
  'menu.usermgr': '用户管理',
  'menu.usermgr.userlist': '用户列表',
  'menu.usermgr.propspresent': '馈赠用户',
  'menu.gamemgr': '游戏管理',
  'menu.gamemgr.gamelist': '游戏列表',
  'menu.gamemgr.gameadd': '添加新游戏',
  'menu.gamemgr.gameaddsuccess': '添加新游戏成功',
  'menu.gamemgr.gameadderror': '添加新游戏失败',
  'menu.gamemgr.gameedit': '编辑游戏',
  'menu.gamemgr.gameview': '游戏详情',
  'menu.wallet': '钱包管理',
  'menu.wallet.walletmgr': '钱包概览',
  'menu.wallet.walletlog': '流水详情',
  'menu.wallet.walletinfo': '收款地址',
  'menu.wallet.walletpay': '转账交易',
  'menu.wallet.walletpaysuccess': '转出成功',
  'menu.wallet.walletpayerror': '转出失败',
  'menu.wallet.walletstep': '备份钱包',
  'menu.wallet.walletstep.info': '生成助记词',
  'menu.wallet.walletstep.confirm': '确认助记词',
  'menu.wallet.walletstep.result': '完成',
  'menu.funding':'众筹管理',
  'menu.funding.fundingapply':'众筹申请',
  'menu.funding.fundinglist':'我的众筹',
  'menu.funding.fundingview':'众筹详情',
  'menu.funding.fundingauditlist':'众筹审核',
  'menu.funding.fundingauditview':'审核详情页',
  'menu.stock':'凭证管理',
  'menu.stock.marketlist':'一级市场',
  'menu.stock.marketview':'凭证详情页',
  'menu.stock.stocklist':'二级市场',
  ...
  'sys.copyright': '2018~2020 百穀王網路',
  'sys.product.description': 'Vallnet - 面向動漫電玩供應商的CRM',
